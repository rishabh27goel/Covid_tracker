...
import {sortData, prettyPrintStats} from './components/util';
...
function App() {
  ...
  const onCountryChange = async (event) =>{
    ...
    const flag = countryCode === 'worldwide' ? 1 : 0;
  ...
  let caseCaps = casesType.charAt(0).toUpperCase() + casesType.slice(1);
